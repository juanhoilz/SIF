...
Public Class Producto
    ...
    Private Sub Btactualizar_Click(sender As Object, e As EventArgs) Handles btactualizar.Click
        ...
        Try
            ...
            MessageBox.Show("El registro se ha actualizado correctamene", "Registro actualizado", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        Catch ex As Exception
            MessageBox.Show("El registro no se actualizó, favor de verificar", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
