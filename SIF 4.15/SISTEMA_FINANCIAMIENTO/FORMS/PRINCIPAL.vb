...
Public Class PRINCIPAL
    ...
    Private Sub UbicaciónToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UbicaciónToolStripMenuItem.Click
        Dim NEWCHILD As New GENERAR_REPORTE_UBICACION
        NEWCHILD.MdiParent = Me
        NEWCHILD.Show()
    End Sub

    Private Sub EditarToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles EditarToolStripMenuItem3.Click
        Dim NEWCHILD As New EDITAR_ACTIVO
        NEWCHILD.MdiParent = Me
        NEWCHILD.Show()
    End Sub
End Class