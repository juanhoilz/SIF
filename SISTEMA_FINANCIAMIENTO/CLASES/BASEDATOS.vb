...
Public Class BASEDATOS
    ...
    Sub LlenarComboMarca(ByVal cb As ComboBox, ByVal cb2 As ComboBox)
        ...
        Try
            Using cn As New SqlConnection(My.Settings.Conexionbd)
                ...
                Dim consulta As String = "Select ID_MARCAS, NOM_MARCA from CAT_MARCA WHERE (PARTIDA_ID = @parametro)"
    ...
    Sub Llenarconsultapersonal(ByVal nombre As String, ByVal dgv As DataGridView)
        ...
        Try
            ...
            adaptador = New SqlDataAdapter("select NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO from TBL_PERSONAL where NOMBRE like '" & "%" + nombre + "%" & "'", cn)
    ...
    Sub LlenarComboProveedores(ByVal cb As ComboBox)
        ...
        Try
            Using cn As New SqlConnection(My.Settings.Conexionbd)
                ...
                Dim consulta As String = "Select NOMBRE_PROVEEDOR FROM TBL_PROVEEDORES ORDER BY NOMBRE_PROVEEDOR"
                Dim cmd As New SqlCommand(consulta, cn)
